...
async function listTheatersByMovieId(req, res){
...
module.exports = {
    ...
    listTheatersByMovieId: [movieExists, listTheatersByMovieId],
    listReviewsByMovieId: [movieExists, listReviewsByMovieId]
}